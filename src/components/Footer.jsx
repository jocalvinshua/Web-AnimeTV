      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="space-y-4 max-w-sm">
          ...
          <p className="text-sm text-muted leading-relaxed">
            The ultimate destination for anime enthusiasts. Track, discover, and
            explore thousands of titles with our high-performance database.
          </p>
          <div className="flex gap-4 text-muted">
            <a href="https://github.com/jocalvinshua/Web-AnimeTV">
              <Github
                size={20}
        ...
        <div className="grid grid-cols-2 gap-12 sm:gap-20">
          <div className="space-y-4">
            <h4 className="text-sm font-bold uppercase tracking-widest text-bright">
              Explore
            </h4>
